...
- Each prompt names a style chosen for this source, at least four named colors, clean sans-serif CJK, and the source-grounded key points written on the image.
